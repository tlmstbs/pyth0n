...
algo_time = timeit.timeit("generate_combinations_algorithmic(K)",globals=globals(), number=1)
...
python_time = timeit.timeit("generate_combinations_python(K)",globals=globals(), number=1)
